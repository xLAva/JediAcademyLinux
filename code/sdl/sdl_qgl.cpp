...
{
    assert( glw_state.OpenGLLib == false );
	...
	qglEnd                       = 	dllEnd                       = (void (APIENTRY *)()) GPA( "glEnd" );
	qglEndList                   = 	dllEndList                   = (void (APIENTRY *)()) GPA( "glEndList" );
	...
	qglFinish                    = 	dllFinish                    = (void (APIENTRY *)()) GPA( "glFinish" );
	qglFlush                     = 	dllFlush                     = (void (APIENTRY *)()) GPA( "glFlush" );
	...
	qglGetError                  = 	dllGetError                  = (GLenum (APIENTRY *)()) GPA( "glGetError" );
	...
	qglGetTexLevelParameterfv    = 	dllGetTexLevelParameterfv    = (void (APIENTRY *)(GLenum, GLint, GLenum, GLfloat*)) GPA( "glGetLevelParameterfv" );
	qglGetTexLevelParameteriv    = 	dllGetTexLevelParameteriv    = (void (APIENTRY *)(GLenum, GLint, GLenum, GLint*)) GPA( "glGetLevelParameteriv" );
	...
	qglInitNames                 = 	dllInitNames                 = (void (APIENTRY *)()) GPA( "glInitNames" );
	...
	qglLoadIdentity              = 	dllLoadIdentity              = (void (APIENTRY *)()) GPA( "glLoadIdentity" );
	...
	qglPopAttrib                 = 	dllPopAttrib                 = (void (APIENTRY *)()) GPA( "glPopAttrib" );
	qglPopClientAttrib           = 	dllPopClientAttrib           = (void (APIENTRY *)()) GPA( "glPopClientAttrib" );
	qglPopMatrix                 = 	dllPopMatrix                 = (void (APIENTRY *)()) GPA( "glPopMatrix" );
	qglPopName                   = 	dllPopName                   = (void (APIENTRY *)()) GPA( "glPopName" );
	...
	qglPushMatrix                = 	dllPushMatrix                = (void (APIENTRY *)()) GPA( "glPushMatrix" );
