...
OVRFUNC(true,  void,             ovr_RecenterTrackingOrigin,     (ovrSession session))
...
OVRFUNC(true,  void,             ovr_DestroySwapTextureSet,      (ovrSession session, ovrTextureSwapChain textureSet))
